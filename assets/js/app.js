(() => {
    ...
    function tabsButton() {
        ...
        let tabsActiveHash = [];
        let tabsNavNext = document.querySelectorAll(".button-next");
        let tabsNavPrev = document.querySelectorAll(".button-prev");
        tabsNavNext.forEach((button => {
        ...
        function switchTabByIndex(tabIndex) {
            if (tabs.length > 0) tabs.forEach((tabsBlock => {
                ...
                if (tabIndex >= 0 && tabIndex < tabTitles.length) {
                    ...
                    if (!tabTitle.classList.contains("_tab-active") && !tabsBlock.querySelector("._slide")) {
                        ...
                        tabActiveTitle ? tabActiveTitle.classList.remove("_tab-active") : null;
                        tabTitle.classList.add("_tab-active");
                        setTabsStatus(tabsBlock);
                    }
                }
        ...
        function switchTabRight() {
            const activeTab = document.querySelector("[data-tabs-title]._tab-active");
            if (activeTab) {
                const tabsBlock = activeTab.closest("[data-tabs]");
                const tabTitles = tabsBlock.querySelectorAll("[data-tabs-title]");
                const activeIndex = Array.from(tabTitles).indexOf(activeTab);
                const nextIndex = (activeIndex + 1) % tabTitles.length;
        ...
        function switchTabLeft() {
            ...
            if (activeTab) {
                ...
                const tabTitles = tabsBlock.querySelectorAll("[data-tabs-title]");
                const activeIndex = Array.from(tabTitles).indexOf(activeTab);
                const prevIndex = (activeIndex - 1 + tabTitles.length) % tabTitles.length;
